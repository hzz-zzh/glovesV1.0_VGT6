...
static void MX_TIM6_Init(void)
{
  ...
  htim6.Instance = TIM6;
  htim6.Init.Prescaler = 8324;
  htim6.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim6.Init.Period = 9989;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, IMU_RST_Pin|TOUCH_ROW_SEL0_Pin|RS485_EN_Pin|TOUCH_COL_SEL4_Pin
  ...
  /*Configure GPIO pins : IMU_RST_Pin TOUCH_ROW_SEL0_Pin RS485_EN_Pin TOUCH_COL_SEL4_Pin
                           TOUCH_COL_SEL3_Pin */
  GPIO_InitStruct.Pin = IMU_RST_Pin|TOUCH_ROW_SEL0_Pin|RS485_EN_Pin|TOUCH_COL_SEL4_Pin
                          |TOUCH_COL_SEL3_Pin;
  ...
  /*Configure GPIO pin : DISABLE_CHARGE_Pin */
  GPIO_InitStruct.Pin = DISABLE_CHARGE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DISABLE_CHARGE_GPIO_Port, &GPIO_InitStruct);
